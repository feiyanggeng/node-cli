...
exports.default = name => {
    ...
    let app = "", targetDir = "", absoluteTargetDir = "", targetModule = name;
    ...
    if (inRootDir && !inModuleDir) {
        if (name.indexOf(app + "/modules") < 0 || !/\/(\w+)$/.test(name)) {
            console.warn(chalk.green('if you want to generate file system in idaas-web project, please enter target directory path like "admin/modules/test" \n'));
            process.exit(1);
        }
    ...
    const ModuleName = targetModule.replace(/^\w/, targetModule.charAt(0).toUpperCase());
    return {
        fileName: {
...
//# sourceMappingURL=GenFileConfig.js.map